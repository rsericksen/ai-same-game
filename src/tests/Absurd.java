...
public class Absurd extends junit.framework.TestCase {
	Problem problem;
	...
	protected void setUp() {
		...
		try {
			problem = new Problem("gggbrrgbr" + "rrbbggbbg" + "rrrbrgbbb" + "ggbgbbbgb" + "rrrrrbbrb" + "bgrrbbbbb" + "gggbbrrbb" + "bbbbbbbbb" 
								+ "rbbrggbgg");
		} catch (Exception e) {
